...
/* Task 4: Implement a higher-order function called `getWinners`, that accepts the 
...
function getAverageGoals(data) {
    ...
    let averagegoal = data.reduce(function(accumulator, item){
        ...
        //   console.log(`The current item ${item["Home Team Goals"]} `)
        return accumulator + (item["Home Team Goals"]+item["Away Team Goals"])/totalGames
    },0);
    return averagegoal
};
